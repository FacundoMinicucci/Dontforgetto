...
export default {
  ...
  methods: {
    agregarTarea() {
      ...
      this.loading = true;
      axios
        .post("https://localhost:44397/api/Tarea", tarea)
        .then((response) => {
    ...
    eliminarTarea(id) {
      this.loading = true;
      axios
        .delete("https://localhost:44397/api/Tarea/" + id)
        .then((response) => {
          console.log(response);
          this.obtenerTareas();
          this.loading = false;
    ...
    editarTarea(tarea, id) {
      this.loading = true;
      axios.put("https://localhost:44397/api/Tarea/" + id, tarea).then(() => {
        this.obtenerTareas();
        this.loading = false;
    ...
    obtenerTareas() {
      this.loading = true;
      axios.get("https://localhost:44397/api/Tarea").then(response => {
        console.log(response);
